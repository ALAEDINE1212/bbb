...
- Token cost: 107,350 input · 0 output
...
- WebRTC Call Engine
- Movies, Icons & Spotlight
- Stats, Dates & PWA Install
- Dock Nav & Design System
- Places Map & Tiles
- App Icons
- Graphify Config
- README
...
10. `Home dashboard screen` - 5 edges
...
### Community 0 - "Firebase Data Layer"
Cohesion: 0.11
...
### Community 2 - "Weather & Home Dashboard"
Cohesion: 0.23
...
### Community 3 - "WebRTC Call Engine"
Cohesion: 0.26
...
### Community 4 - "Movies, Icons & Spotlight"
Cohesion: 0.24
...
### Community 5 - "Stats, Dates & PWA Install"
Cohesion: 0.20
...
### Community 6 - "Dock Nav & Design System"
Cohesion: 0.25
...
## Knowledge Gaps
- **41 isolated node(s):** `background_color`, `categories`, `description`, `dir`, `display` (+36 more)
...
- **Why does `Our Little Universe (couple app)` connect `Firebase Data Layer` to `Weather & Home Dashboard`, `WebRTC Call Engine`, `Movies, Icons & Spotlight`, `Dock Nav & Design System`, `Places Map & Tiles`?**
  _High betweenness centrality (0.265) - this node is a cross-community bridge._
- **Why does `Icon refresher (refreshIcons + MutationObserver)` connect `Movies, Icons & Spotlight` to `Firebase Data Layer`, `Weather & Home Dashboard`, `Stats, Dates & PWA Install`, `Places Map & Tiles`?**
  _High betweenness centrality (0.244) - this node is a cross-community bridge._
- **Why does `PWA install prompt and iOS fallback` connect `Stats, Dates & PWA Install` to `PWA Manifest`?**
...
- **Should `Firebase Data Layer` be split into smaller, more focused modules?**
